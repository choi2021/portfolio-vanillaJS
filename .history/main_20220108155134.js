...
menu.addEventListener("click", (e) => {
  ...
  switch (section) {
    ...
    case "about":
      ...
      break;
    case "skills":
      skills.scrollIntoView({ behavior: "smooth", block: "center", inline: "center" });
      break;
    case "work":
      work.scrollIntoView({ behavior: "smooth", block: "center", inline: "center" });
      break;
    case "testimonials":
      testimonials.scrollIntoView({ behavior: "smooth", block: "center" inline: "center" });
      break;
    case "contact":
      contact.scrollIntoView({ behavior: "smooth", block: "center" inline: "center" });
      break;
    default:
